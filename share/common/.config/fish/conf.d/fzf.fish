...
bind --mode insert \cl '__fish_list_current_token'
bind --mode insert \el '__fzf_search_git_log'
bind --mode insert \es '__fzf_search_git_status'
bind --mode insert \eb '__fzf_search_git_branch'
